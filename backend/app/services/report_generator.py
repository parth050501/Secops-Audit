...
def generate_pdf_report(report: dict) -> bytes:
    ...
    brand_tbl = Table([[
        ...
        Paragraph("<b>SecOps AI</b> &nbsp;<font size=9 color='#99f6e4'>Governance &amp; Compliance Platform</font>", logo_style),
    ...
    elems.append(Paragraph("Generated by SecOps AI — Human-in-the-Loop Governance Platform. "
