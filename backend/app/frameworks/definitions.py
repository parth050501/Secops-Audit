...
CONNECTOR_CATALOG = [
    ...
    {"type":"mssql",          "category":"database",  "name":"MS SQL Server (agent)",    "icon":"🗄️", "collection":["audit","config","users","access"]},
    {"type":"mysql",          "category":"database",  "name":"MySQL / MariaDB",          "icon":"🐬", "collection":["audit","config","users"]},
