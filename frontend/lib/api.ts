...
export const bulkUploadControls = (fwId: number, file: File) => {
  const fd = new FormData(); fd.append('file', file);
  return api.post(`/api/frameworks/${fwId}/controls/bulk-upload`, fd, { headers: { 'Content-Type': 'multipart/form-data' } });
};
