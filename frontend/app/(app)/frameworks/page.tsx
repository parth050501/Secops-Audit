...
export default function FrameworksPage() {
  ...
  const doBulkUpload = async (file: File) => {
    ...
    try { const r = await bulkUploadControls(selected.id, file); setMsg(`Imported ${r.data.created} controls${r.data.error_count ? `, ${r.data.error_count} skipped` : ''}.`); reloadControls(); }
